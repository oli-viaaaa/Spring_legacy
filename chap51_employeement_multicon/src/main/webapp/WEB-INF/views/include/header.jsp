...
<head>
	...
	<!-- Logout/Login 토글(로그인되어 있으면 "로그아웃" 안되어 있으면 "로그인") -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href='<c:url value="/board/boardList.do" />'><i class="fa fa-dashboard fa-fw"></i>사원게시판</a>
                        </li>
                        <li>
                            <a href='#'><i class="fa fa-bar-chart-o fa-fw"></i>사원(Employee)<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href='<c:url value="/emp/list.do" />'>사원목록</a>
                                </li>
                                <li>
                                    <a href='<c:url value="/board/boardList.do" />'>사원게시판</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
